<?php 
  ...
  echo $CI->view_library->html_title('building', 'Partner'); // icon, title
  ...
  echo $CI->view_library->js_Header();
    ...
    echo $CI->view_library->js_loadGridData('gridOptions', 'partner/list_json');
    echo $CI->view_library->js_addEventListener('gridOptions', 'myGrid');
    echo $CI->view_library->js_processRow('AddRow', 'formCreate', 'partner/create', 'messageCreate', 'modalCreate');
    echo $CI->view_library->js_processRow('DeleteRow', 'formDelete', 'partner/delete', 'messageDelete', 'modalDelete');
    echo $CI->view_library->js_processRow('UpdateRow', 'formUpdate', 'partner/update', 'messageUpdate', 'modalUpdate');
