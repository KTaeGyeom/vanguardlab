<?php 
  ...
  echo $CI->view_library->html_title('building', 'Clients'); // icon, title
  ...
  echo $CI->view_library->js_Header();
    ...
    echo $CI->view_library->js_loadGridData('gridOptions', 'client/list_json');
    echo $CI->view_library->js_addEventListener('gridOptions', 'myGrid');
    echo $CI->view_library->js_processRow('AddRow', 'formCreate', 'client/create', 'messageCreate', 'modalCreate');
    echo $CI->view_library->js_processRow('DeleteRow', 'formDelete', 'client/delete', 'messageDelete', 'modalDelete');
    echo $CI->view_library->js_processRow('UpdateRow', 'formUpdate', 'client/update', 'messageUpdate', 'modalUpdate');
